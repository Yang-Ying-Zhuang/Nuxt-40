  ...
  <div class="search-form">
    ...
    <el-form class="search-form-content" ref="form" label-width="80px">
      ...
      <el-form-item label="到达城市">
        <!-- select:选中下拉框时候触发事件  v-model="form.departCode"-->
        <el-autocomplete
      ...
      <el-form-item label>
        <el-button style="width:100%;" type="primary" 
           icon="el-icon-search" @click="handleSubmit">
           搜索
        </el-button>
      </el-form-item>
      <div class="reverse">
...
export default {
 ...
 // 出发城市输入框失去焦点时候默认选中第一个城市
    ...
    // 监听出发城市输入时候触发的事件
    // value 是选中的值
    // cb是回调函数，接收要展示的列表，注意参数必须是数组，数组中元素必须是对象，对象中必须包含value属性
     queryDepartSearch(value, callback) {
      ...
      this.$axios({
        ...
        params: {
          ...
          // console.log(res)
        const { data } = res.data;
        // // 循环给data中每一项添加一个vlaue属性，并且没有市字的
   ...
   // 目标城市下拉选择时出发
    ...
    handleDate(value) {
      // console.log(value)
        this.form.departDate = moment(value).format("YYYY-MM-DD") //当天日期开始2019-12-31
